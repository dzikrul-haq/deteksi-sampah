...
def detections(request):
    data = os.listdir('static/streamapp/output')
    imgs = []
    for item in data:
        imgs.append(os.path.abspath(os.path.join('static/streamapp/output', item)))
    return render(request, 'streamapp/pages/detections.html', {'data': imgs})
